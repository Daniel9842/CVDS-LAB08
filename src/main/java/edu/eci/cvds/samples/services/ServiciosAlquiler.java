...
public interface ServiciosAlquiler {
   ...
   */
   ...
   public abstract void tarifaItem(int id, long tarifa) throws ExcepcionServiciosAlquiler;

   public abstract void registrarItem(Item i) throws ExcepcionServiciosAlquiler;

   public abstract void vetar(long docu, boolean estado) throws ExcepcionServiciosAlquiler;
